      ...
      <div className="jumbotron">
        <Container>
          ...
          <Row>
            ...
            <Col>
              <Button variant="info" onClick={() => definirOperacao(DIVISAO)}>
                /
              </Button>
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col>
              <Button variant="info" onClick={() => definirOperacao(SUBTRACAO)}>
                -
              </Button>
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col>
              <Button variant="info" onClick={() => definirOperacao(SOMA)}>
                +
              </Button>
            </Col>
          </Row>
